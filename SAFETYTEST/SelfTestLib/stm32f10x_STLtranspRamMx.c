...
* File Name          : stm32f10x_STLtranspRamMx.c
* Author             : MCD Application Team
* Version            : V1.0
* Date               : 10/05/2007
* Description        : This module contains functions for transparent RAM
*                      functional test using March X, to be done during run-time.
********************************************************************************
...
/*******************************************************************************
* Function Name  : STL_TranspMarchXInit
...
/*******************************************************************************
* Function Name  : STL_TranspMarchX
* Description    : This function verifies that 6 words of RAM are functional,
                    (with overlapping) using the March X algorithm.
* Input          : None
* Output         : None
