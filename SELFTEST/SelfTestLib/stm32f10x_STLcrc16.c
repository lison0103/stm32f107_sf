...
* File Name          : stm32f10x_STLcrc16.c
* Author             : IAR Systems: see credits here-below.
* Version            : V1.0
* Date               : 10/01/2007
* Description        : This file contains the function returning a 16-bit CRC
...
/******************************************************************************/
/****************************** CREDITS ***************************************/
/******************* ORIGINAL HEADER FILE REPRODUCED AS IS ********************/
/******************************************************************************/
/*                              - checksum.c -
...
/*******************************************************************************
* Function Name  : STL_crc16
* Description    : Computes the 16-bit CRC of a given part of the memory
*                  (byte per byte).
* Input          : - sum: holds the initialization value of the CRC, or its
*   				         previous value when processed in multiple passes
*                  - p: points to the first memory byte to be taken into account
