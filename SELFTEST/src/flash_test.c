...
const FlashCRC_t IEC61508_Flash_CRC_REF @ "_CRC_area" = ENTRY_FLASH_CRC;
/*! @endcond */
#else
#error "iec61508_flash_test.c: undefined compiler"
#endif
...
type_testResult_t IEC61508_FLASHtest_POST2(void)
{
  ...
  {
    //CRC32_Val = TestCRC.CRC32Val;
    if (TestCRC.CRC32Val == CRC32_Val)//IEC61508_Flash_CRC_REF.CRC32Val)
    {
      Result = IEC61508_testPassed;
    }
  }
...
type_testResult_t IEC61508_FLASHtest_BIST(uint8_t StartMode)
{
  ...
  if (StartMode >= FLASH_CRC_Restart)
  {
    ...
    Result              = IEC61508_testInProgress;
  }
  ...
  {
    if (bistFlashCRC.CRC32Val == IEC61508_Flash_CRC_REF.CRC32Val)
    {
      Result = IEC61508_testPassed;
    }
  }
